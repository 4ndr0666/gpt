...
function promptDropdown() {
  ...
  chrome.storage.local.get(['customPrompts'], (result) => {
    ...
    for (let i = 0; i < allPrompts.length; i += 1) {
      ...
      dropdownItem.classList = 'text-token-text-primary relative cursor-pointer select-none border-b p-2 last:border-0 border-gray-100 dark:border-white/20 hover:bg-gray-500/10';
